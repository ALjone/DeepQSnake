...
class DQAgent:
    def __init__(self, loops, load_path: str = None) -> None:
        self.bank: MemoryBank = MemoryBank(2000)
        self.testing = False
        self.turn = 0
        ...
        self.epsilon = 1/(loops*1.1)
        self.previous_memory = None

    def _exploration_rate(self):
        return (1-(self.epsilon*self.turn))-0.25
    ...
    def get_move(self, game: Game):
        ...
        memory.life = game.moves_since_ate/game.lifespan
    ...
    def _get_reward(self, game: Game):
    ...
    def _predict(self, game: Game):
        ...
        return torch.argmax(self.trainer.model(self._get_features(game.game_map), game.moves_since_ate/game.lifespan))
